...
- **IA Generativa / LLM:** Google Gemini API (`google-genai` SDK) — Modelo `gemini-3.6-flash` / `gemini-2.5-flash`
...
Bash
git clone [https://github.com/casousa-lab/assistente-ia-texto.git](https://github.com/casousa-lab/assistente-ia-texto.git)
...
Cole o texto desejado dentro do arquivo input.txt.
